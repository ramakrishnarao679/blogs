...
import {AppBar, Box, Toolbar, Badge, Typography, MenuItem, Menu } from '@mui/material';
      ...
      <AppBar position="static" sx={{backgroundColor:'purple'}}>
        <Toolbar>
          ...
          <Box sx={{ display: { xs: 'flex', md: 'none' } }}>
            <IconButton size="large" aria-label="show more" aria-controls={mobileMenuId} color="inherit" 
               aria-haspopup="true" onClick={handleMobileMenuOpen} >
                <MoreIcon />
            </IconButton>
          </Box>
        </Toolbar>
